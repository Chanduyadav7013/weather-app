...
document.querySelector('.search-box').addEventListener('keyup',function(evt){
    if (evt.keyCode == 13) {
      ...
      function displayResults (weather) {
        ...
        document.querySelector('.yest').innerHTML=`yesterday:${weather.forecast[0].temperature},today:${weather.forecast[1].temperature},tommorow:${weather.forecast[2].temperature}`
